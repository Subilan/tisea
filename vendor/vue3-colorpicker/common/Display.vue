<template>
  <div class="vc-display">
    ...
    <div class="vc-color-input">
      <input :style="{borderColor: state.color}" :value="state.hex" @input="onInputChange"/>
    </div>
    <div class="vc-alpha-input" v-if="!disableAlpha">
      <input :style="{borderColor: state.color}" class="vc-alpha-input__inner" :value="state.alpha" @input="onAlphaBlur"/>
    </div>
  </div>
</template>
